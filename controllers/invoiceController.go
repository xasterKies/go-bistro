...
func GetInvoices() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "errror occured while listing order items"})
		}
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			var msg = fmt.Sprintf("message: Order was not found")
...
func UpdateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			msg := fmt.Sprintf("invoice itnem update failed")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
